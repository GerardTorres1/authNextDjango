...
SECRET_KEY = 'django-insecure-w4l+6j2t#=lja2!!krse-tw^-r8#ya_ueb^ltg8cbm8cuer1az'
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'authentication.serializers.CustomUserModelSerializer'
}
